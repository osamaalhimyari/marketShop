<div>
    ...
    <label class="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full" for="light-switch">
        <svg class="dark:hidden fill-current text-gray-500/80 dark:text-gray-400/80"height="30px"  width="30px"  viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="hidden dark:block fill-current text-gray-500/80 dark:text-gray-400/80"height="30px"  width="30px"  viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
